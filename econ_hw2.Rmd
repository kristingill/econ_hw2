...
#combined graphs
ggplot() +
  geom_line(data = water_data, aes(x = reduced_water_use_abatement,y = mc_urban), color = "red")+
  geom_line(data = water_data, aes(x = reduced_water_use_abatement, y = mc_industrial), color = "blue")+
  geom_line(data = water_data, aes(x = reduced_water_use_abatement, y=mc_meat), color = "black")+
