...
#combined graphs
og_data <- ggplot() +
  geom_line(data = water_data, aes(x = reduced_water_use_abatement,y = mc_urban), color = "blue") +
  geom_line(data = water_data, aes(x = reduced_water_use_abatement, y = mc_industrial), color = "purple") +
  geom_line(data = water_data, aes(x = reduced_water_use_abatement, y=mc_meat), color = "red") +
  geom_line(data = water_data, aes(x = reduced_water_use_abatement, y=mc_agriculture), color = "green") +
  labs(x = "Abatement (Acre Feet)",
       y = "Price ($/Acre Feet)",
...
reg_data <- ggplot() +
  ...
  geom_line(data = industrial_df, aes(x = abatement, y = price, color = "purple")) +
  ...
  scale_color_manual(labels = c("Urban", "Industrial", "Meat", "Agriculture"), values = c("blue", "purple", "red", "green"))
